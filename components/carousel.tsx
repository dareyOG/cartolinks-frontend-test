...
/* import coalitionForces from '/images/coalition-forces.jpg';
import cityArchitecture from '/images/city-architecture.jpg';
import moodyLondon from '/images/moody-london.jpg';
import townDusk from '/images/town-dusk.jpg';
import grazing from '/images/grazing.jpg';
import dollarBill from '/images/dollar-bill.jpg';
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-x-10 ">
            <Button
              ...
              className="bg-stone-200 rounded-[2rem] p-1.5 hover:bg-stone-300"
            >
              <HiChevronLeft />
            </Button>
            <Button
